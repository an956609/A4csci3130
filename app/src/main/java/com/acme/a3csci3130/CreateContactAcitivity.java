...
public class CreateContactAcitivity extends Activity {
    ...
    /**
     * Adds the values form the text fields in this activity to a firebase
     * entry.
    ...
    public void submitInfoButton(View v) {
        ...
        Contact businessContact = new Contact(businessID, name, number,
                business, address, province);

        appState.firebaseReference.child(businessID).setValue(businessContact);
